...
@Test
public class ApiTestGetTradeInfo extends ApiGeneralCases {
	
	//definition of conditions
	final static int invalidAccessToken	= 1<<0;
	final static int noAccessToken	    = 1<<1;
	final static int validAccessToken	= 1<<2;
	...
	private void TestTradeInfo(Object param, JSONArray detail)
	{
		...
		String api_path = "/account/v1/transaction" ;
		parameter.clear();
	...
	public void b_accessTokenTest()
	{
		...
		for (int i =0 ;i<2;++i)
		{
			TestTradeInfo(conditions[i],null);
		}
