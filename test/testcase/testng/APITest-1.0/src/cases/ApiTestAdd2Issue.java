...
@Test
public class ApiTestAdd2Issue extends ApiGeneralCases {
	
	//definition of conditions
	
	
	
	final static int noAssetCode		= 1<<19;
	final static int invalidAssetCode	= 1<<20;
	final static int validAssetCode		= 1<<21;
	...
	static int index = 0;
	@Test(enabled = false)
	public void TestProcess(String param, JSONArray detail) 
	{
	...
	private void Verification(JSONObject jsonObject)
	{
		...
		switch (current_condition)
		{
			...
			case 0:
				...
				check.equals((String)jsonObject.getJSONObject("data").get("asset_code"),assetcode.toString(),"assetcode is not as expected");
	...
	public void Confirmation(boolean issuccess,String ...param)
	{
		...
		if(issuccess)
		{
			...
			check.equals((String)jsonObject.getJSONObject("data").get("bc_hash"),(String)param[0],"hash is not as expected");				
