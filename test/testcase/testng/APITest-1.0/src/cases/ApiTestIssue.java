...
@Test
public class ApiTestIssue extends ApiGeneralCases {
	...
	static String amount = new String();
	...
	public void TestProcess(Object param, JSONArray detail)
	{
		...
		amount = (String) thrMap.get("asset_amount");
	...
	private void Verification(JSONObject jsonObject)
	{
		...
		switch (current_condition)
		{
			...
			case 0:
				...
				check.equals(Integer.toString((int) jsonObject.getJSONObject("data").get("asset_amount")),amount,"amount is not as expected");
				...
				Confirmation(true,asset_code,hash);
				break;
	...
	@Test(enabled = false)
	public void Confirmation(boolean issuccess,Object ...param)
	{
		...
		if(issuccess)
		{
			...
			check.equals((String)jsonObject.getJSONObject("data").get("asset_unit"),asset_unit,"unit is not as expected");
			check.equals((String)jsonObject.getJSONObject("data").get("asset_name"),asset_name,"name is not as expected");
			check.equals((String)jsonObject.getJSONObject("data").get("asset_code"),(String)param[0],"asset_code is not as expected");			
			check.equals((String)jsonObject.getJSONObject("data").get("bc_hash"),(String)param[1],"hash is not as expected");				
