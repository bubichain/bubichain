...
public class HttpUtil extends TestBase
{
	...
	public static String dogetApi(String baseurl,String apipath,LinkedHashMap<String, Object> keyvalues)
	{
		String result = null;
		...
		do
		{
			...
			for (Iterator it =  keyvalues.keySet().iterator();it.hasNext();)
		   {
				Object key = it.next();
			    try {
					url+= URLEncoder.encode((String)key,"utf-8") +"=" + URLEncoder.encode((String)keyvalues.get(key),"utf-8") + "&";
	...
	public static String dopostApi(String baseurl,String apipath,LinkedHashMap<String, Object> keyvalues,JSONObject jsonObject)
	{
		String result = null;
		String url = baseurl + apipath;
